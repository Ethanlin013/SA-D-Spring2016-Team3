...
import controllers.ProfileController.FollowType;
import play.Logger;
...
public class User {
	...
	//JWQ
	public static List<User> getFollow(Long id, FollowType f) {
	...
	public static JsonNode follow(Long id, String sessionId) {
		String followQuery = Constants.NEW_BACKEND
				+ "users/follow/followerId/"
				+ sessionId
				+ "/followeeId/"
				+ id.toString();
		return APICall.callAPI(followQuery);
	}

	public static JsonNode unfollow(Long id, String sessionId) {
		String unfollowQuery = Constants.NEW_BACKEND
				+ "users/unfollow/followerId/"
				+ sessionId
				+ "/followeeId/"
				+ id.toString();
		return APICall.callAPI(unfollowQuery);
	}
