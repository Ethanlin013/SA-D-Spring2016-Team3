...
// @HASH:cfee75fc0c37877aac97f660ae5a3183492bc546
// @DATE:Tue Apr 26 00:40:41 UTC 2016
...
// @LINE:72
private[this] lazy val controllers_UserController_suggestGroupName49_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/suggestGroupName/email/"),DynamicPart("email", """[^/]+""",true),StaticPart("/name/"),DynamicPart("name", """[^/]+""",true))))
private[this] lazy val controllers_UserController_suggestGroupName49_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).suggestGroupName(fakeValue[String], fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.UserController", "suggestGroupName", Seq(classOf[String], classOf[String]),"GET", """""", Routes.prefix + """users/suggestGroupName/email/$email<[^/]+>/name/$name<[^/]+>"""))
        

// @LINE:75
private[this] lazy val controllers_WorkflowController_post50_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/post"))))
private[this] lazy val controllers_WorkflowController_post50_invoker = createInvoker(
...
// @LINE:76
private[this] lazy val controllers_WorkflowController_updateWorkflow51_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/updateWorkflow"))))
private[this] lazy val controllers_WorkflowController_updateWorkflow51_invoker = createInvoker(
...
// @LINE:77
private[this] lazy val controllers_WorkflowController_deleteWorkflow52_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/deleteWorkflow"))))
private[this] lazy val controllers_WorkflowController_deleteWorkflow52_invoker = createInvoker(
...
// @LINE:78
private[this] lazy val controllers_WorkflowController_get53_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/get/workflowID/"),DynamicPart("wfID", """[^/]+""",true),StaticPart("/userID/"),DynamicPart("userID", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_WorkflowController_get53_invoker = createInvoker(
...
// @LINE:79
private[this] lazy val controllers_WorkflowController_getTimeLine54_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getTimeline/"),DynamicPart("id", """[^/]+""",true),StaticPart("/offset/"),DynamicPart("offset", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_WorkflowController_getTimeLine54_invoker = createInvoker(
...
// @LINE:80
private[this] lazy val controllers_WorkflowController_getWorkflowList55_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getWorkflowList/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_WorkflowController_getWorkflowList55_invoker = createInvoker(
...
// @LINE:81
private[this] lazy val controllers_WorkflowController_uploadImage56_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/uploadImage/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_WorkflowController_uploadImage56_invoker = createInvoker(
...
// @LINE:82
private[this] lazy val controllers_WorkflowController_getPublicWorkflow57_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getPublicWorkflow/json"))))
private[this] lazy val controllers_WorkflowController_getPublicWorkflow57_invoker = createInvoker(
...
// @LINE:84
private[this] lazy val controllers_WorkflowController_getTags58_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getTags/workflowId/"),DynamicPart("wfId", """[^/]+""",true))))
private[this] lazy val controllers_WorkflowController_getTags58_invoker = createInvoker(
...
// @LINE:85
private[this] lazy val controllers_WorkflowController_setTag59_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/setTag"))))
private[this] lazy val controllers_WorkflowController_setTag59_invoker = createInvoker(
...
// @LINE:86
private[this] lazy val controllers_WorkflowController_deleteTag60_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/deleteTag/workflowId/"),DynamicPart("wfId", """[^/]+""",true),StaticPart("/tag/"),DynamicPart("tag", """[^/]+""",true))))
private[this] lazy val controllers_WorkflowController_deleteTag60_invoker = createInvoker(
...
// @LINE:87
private[this] lazy val controllers_WorkflowController_getByTag61_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getByTag/tag/"),DynamicPart("tag", """[^/]+""",true))))
private[this] lazy val controllers_WorkflowController_getByTag61_invoker = createInvoker(
...
// @LINE:88
private[this] lazy val controllers_WorkflowController_getByTitle62_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getByTitle/title/"),DynamicPart("title", """[^/]+""",true))))
private[this] lazy val controllers_WorkflowController_getByTitle62_invoker = createInvoker(
...
// @LINE:89
private[this] lazy val controllers_WorkflowController_getTop3WorkFlow63_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getTop3WorkFlow"))))
private[this] lazy val controllers_WorkflowController_getTop3WorkFlow63_invoker = createInvoker(
...
// @LINE:92
private[this] lazy val controllers_MailController_sendMail64_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("mail/sendMail"))))
private[this] lazy val controllers_MailController_sendMail64_invoker = createInvoker(
...
// @LINE:93
private[this] lazy val controllers_MailController_readMail65_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("mail/getMailDetail/mailId/"),DynamicPart("mailId", """[^/]+""",true))))
private[this] lazy val controllers_MailController_readMail65_invoker = createInvoker(
...
// @LINE:94
private[this] lazy val controllers_MailController_getInbox66_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("mail/getInbox/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_MailController_getInbox66_invoker = createInvoker(
...
// @LINE:95
private[this] lazy val controllers_MailController_getOutbox67_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("mail/getOutbox/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_MailController_getOutbox67_invoker = createInvoker(
...
// @LINE:98
private[this] lazy val controllers_SuggestionsController_publishSuggestion68_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("suggestion/publishSuggestion"))))
private[this] lazy val controllers_SuggestionsController_publishSuggestion68_invoker = createInvoker(
...
// @LINE:99
private[this] lazy val controllers_SuggestionsController_addTag69_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("suggestion/addTag"))))
private[this] lazy val controllers_SuggestionsController_addTag69_invoker = createInvoker(
...
// @LINE:100
private[this] lazy val controllers_SuggestionsController_voteToSuggestion70_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("suggestion/voteToSuggestion/"),DynamicPart("suggestionId", """[^/]+""",true))))
private[this] lazy val controllers_SuggestionsController_voteToSuggestion70_invoker = createInvoker(
...
// @LINE:101
private[this] lazy val controllers_SuggestionsController_getSuggestionForWorkflow71_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("suggestion/getSuggestionForWorkflow/"),DynamicPart("workflowId", """[^/]+""",true))))
private[this] lazy val controllers_SuggestionsController_getSuggestionForWorkflow71_invoker = createInvoker(
...
// @LINE:105
private[this] lazy val controllers_TagController_createTag72_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tag/createTag"))))
private[this] lazy val controllers_TagController_createTag72_invoker = createInvoker(
...
// @LINE:106
private[this] lazy val controllers_TagController_deleteTag73_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tag/deleteTag"))))
private[this] lazy val controllers_TagController_deleteTag73_invoker = createInvoker(
...
// @LINE:110
private[this] lazy val controllers_GroupUsersController_createGroup74_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("group/createGroup"))))
private[this] lazy val controllers_GroupUsersController_createGroup74_invoker = createInvoker(
...
// @LINE:111
private[this] lazy val controllers_GroupUsersController_addMembersToGroup75_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("group/addMembersToGroup"))))
private[this] lazy val controllers_GroupUsersController_addMembersToGroup75_invoker = createInvoker(
...
// @LINE:112
private[this] lazy val controllers_GroupUsersController_getGroupList76_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("group/getGroupList/"),DynamicPart("userID", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_GroupUsersController_getGroupList76_invoker = createInvoker(
...
// @LINE:113
private[this] lazy val controllers_GroupUsersController_getGroupMember77_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("group/getGroupMember/"),DynamicPart("groupId", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_GroupUsersController_getGroupMember77_invoker = createInvoker(
...
// @LINE:117
private[this] lazy val controllers_Assets_at78_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("assets/"),DynamicPart("file", """.+""",false))))
private[this] lazy val controllers_Assets_at78_invoker = createInvoker(
controllers.Assets.at(fakeValue[String], fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Assets", "at", Seq(classOf[String], classOf[String]),"GET", """ Map static resources from the /public folder to the /assets URL path""", Routes.prefix + """assets/$file<.+>"""))
        

// @LINE:122
private[this] lazy val controllers_WorkflowController_addComment79_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/addComment"))))
private[this] lazy val controllers_WorkflowController_addComment79_invoker = createInvoker(
...
// @LINE:123
private[this] lazy val controllers_WorkflowController_getComments80_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/getComments/"),DynamicPart("workflowId", """[^/]+""",true))))
private[this] lazy val controllers_WorkflowController_getComments80_invoker = createInvoker(
...
// @LINE:125
private[this] lazy val controllers_CommentController_addReply81_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Comment/addReply"))))
private[this] lazy val controllers_CommentController_addReply81_invoker = createInvoker(
...
// @LINE:127
private[this] lazy val controllers_CommentController_getReply83_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Comment/getReply/"),DynamicPart("commentId", """[^/]+""",true))))
private[this] lazy val controllers_CommentController_getReply83_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).getReply(fakeValue[Long]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.CommentController", "getReply", Seq(classOf[Long]),"GET", """""", Routes.prefix + """Comment/getReply/$commentId<[^/]+>"""))
        

// @LINE:128
private[this] lazy val controllers_CommentController_thumbUp84_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Comment/thumbUp/"),DynamicPart("commentId", """[^/]+""",true))))
private[this] lazy val controllers_CommentController_thumbUp84_invoker = createInvoker(
...
// @LINE:129
private[this] lazy val controllers_CommentController_thumbDown85_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Comment/thumbDown/"),DynamicPart("commentId", """[^/]+""",true))))
private[this] lazy val controllers_CommentController_thumbDown85_invoker = createInvoker(
...
// @LINE:72
case controllers_UserController_suggestGroupName49_route(params) => {
   call(params.fromPath[String]("email", None), params.fromPath[String]("name", None)) { (email, name) =>
        controllers_UserController_suggestGroupName49_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).suggestGroupName(email, name))
   }
}
        

// @LINE:75
case controllers_WorkflowController_post50_route(params) => {
   call { 
        controllers_WorkflowController_post50_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).post)
   }
}
        

// @LINE:76
case controllers_WorkflowController_updateWorkflow51_route(params) => {
   call { 
        controllers_WorkflowController_updateWorkflow51_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).updateWorkflow)
   }
}
        

// @LINE:77
case controllers_WorkflowController_deleteWorkflow52_route(params) => {
   call { 
        controllers_WorkflowController_deleteWorkflow52_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).deleteWorkflow)
   }
}
        

// @LINE:78
case controllers_WorkflowController_get53_route(params) => {
   call(params.fromPath[Long]("wfID", None), params.fromPath[Long]("userID", None), Param[String]("format", Right("json"))) { (wfID, userID, format) =>
        controllers_WorkflowController_get53_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).get(wfID, userID, format))
   }
}
        

// @LINE:79
case controllers_WorkflowController_getTimeLine54_route(params) => {
   call(params.fromPath[Long]("id", None), params.fromPath[Long]("offset", None), Param[String]("format", Right("json"))) { (id, offset, format) =>
        controllers_WorkflowController_getTimeLine54_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getTimeLine(id, offset, format))
   }
}
        

// @LINE:80
case controllers_WorkflowController_getWorkflowList55_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_WorkflowController_getWorkflowList55_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getWorkflowList(id, format))
   }
}
        

// @LINE:81
case controllers_WorkflowController_uploadImage56_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_WorkflowController_uploadImage56_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).uploadImage(id))
   }
}
        

// @LINE:82
case controllers_WorkflowController_getPublicWorkflow57_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_WorkflowController_getPublicWorkflow57_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getPublicWorkflow(format))
   }
}
        

// @LINE:84
case controllers_WorkflowController_getTags58_route(params) => {
   call(params.fromPath[Long]("wfId", None)) { (wfId) =>
        controllers_WorkflowController_getTags58_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getTags(wfId))
   }
}
        

// @LINE:85
case controllers_WorkflowController_setTag59_route(params) => {
   call { 
        controllers_WorkflowController_setTag59_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).setTag)
   }
}
        

// @LINE:86
case controllers_WorkflowController_deleteTag60_route(params) => {
   call(params.fromPath[Long]("wfId", None), params.fromPath[String]("tag", None)) { (wfId, tag) =>
        controllers_WorkflowController_deleteTag60_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).deleteTag(wfId, tag))
   }
}
        

// @LINE:87
case controllers_WorkflowController_getByTag61_route(params) => {
   call(params.fromPath[String]("tag", None)) { (tag) =>
        controllers_WorkflowController_getByTag61_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getByTag(tag))
   }
}
        

// @LINE:88
case controllers_WorkflowController_getByTitle62_route(params) => {
   call(params.fromPath[String]("title", None)) { (title) =>
        controllers_WorkflowController_getByTitle62_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getByTitle(title))
   }
}
        

// @LINE:89
case controllers_WorkflowController_getTop3WorkFlow63_route(params) => {
   call { 
        controllers_WorkflowController_getTop3WorkFlow63_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getTop3WorkFlow())
   }
}
        

// @LINE:92
case controllers_MailController_sendMail64_route(params) => {
   call { 
        controllers_MailController_sendMail64_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.MailController]).sendMail)
   }
}
        

// @LINE:93
case controllers_MailController_readMail65_route(params) => {
   call(params.fromPath[Long]("mailId", None)) { (mailId) =>
        controllers_MailController_readMail65_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.MailController]).readMail(mailId))
   }
}
        

// @LINE:94
case controllers_MailController_getInbox66_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_MailController_getInbox66_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.MailController]).getInbox(id, format))
   }
}
        

// @LINE:95
case controllers_MailController_getOutbox67_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_MailController_getOutbox67_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.MailController]).getOutbox(id, format))
   }
}
        

// @LINE:98
case controllers_SuggestionsController_publishSuggestion68_route(params) => {
   call { 
        controllers_SuggestionsController_publishSuggestion68_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SuggestionsController]).publishSuggestion)
   }
}
        

// @LINE:99
case controllers_SuggestionsController_addTag69_route(params) => {
   call { 
        controllers_SuggestionsController_addTag69_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SuggestionsController]).addTag)
   }
}
        

// @LINE:100
case controllers_SuggestionsController_voteToSuggestion70_route(params) => {
   call(params.fromPath[Long]("suggestionId", None)) { (suggestionId) =>
        controllers_SuggestionsController_voteToSuggestion70_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SuggestionsController]).voteToSuggestion(suggestionId))
   }
}
        

// @LINE:101
case controllers_SuggestionsController_getSuggestionForWorkflow71_route(params) => {
   call(params.fromPath[Long]("workflowId", None)) { (workflowId) =>
        controllers_SuggestionsController_getSuggestionForWorkflow71_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SuggestionsController]).getSuggestionForWorkflow(workflowId))
   }
}
        

// @LINE:105
case controllers_TagController_createTag72_route(params) => {
   call { 
        controllers_TagController_createTag72_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.TagController]).createTag)
   }
}
        

// @LINE:106
case controllers_TagController_deleteTag73_route(params) => {
   call { 
        controllers_TagController_deleteTag73_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.TagController]).deleteTag)
   }
}
        

// @LINE:110
case controllers_GroupUsersController_createGroup74_route(params) => {
   call { 
        controllers_GroupUsersController_createGroup74_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.GroupUsersController]).createGroup)
   }
}
        

// @LINE:111
case controllers_GroupUsersController_addMembersToGroup75_route(params) => {
   call { 
        controllers_GroupUsersController_addMembersToGroup75_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.GroupUsersController]).addMembersToGroup)
   }
}
        

// @LINE:112
case controllers_GroupUsersController_getGroupList76_route(params) => {
   call(params.fromPath[Long]("userID", None), Param[String]("format", Right("json"))) { (userID, format) =>
        controllers_GroupUsersController_getGroupList76_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.GroupUsersController]).getGroupList(userID, format))
   }
}
        

// @LINE:113
case controllers_GroupUsersController_getGroupMember77_route(params) => {
   call(params.fromPath[Long]("groupId", None), Param[String]("format", Right("json"))) { (groupId, format) =>
        controllers_GroupUsersController_getGroupMember77_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.GroupUsersController]).getGroupMember(groupId, format))
   }
}
        

// @LINE:117
case controllers_Assets_at78_route(params) => {
   call(Param[String]("path", Right("/")), params.fromPath[String]("file", None)) { (path, file) =>
        controllers_Assets_at78_invoker.call(controllers.Assets.at(path, file))
   }
}
        

// @LINE:122
case controllers_WorkflowController_addComment79_route(params) => {
   call { 
        controllers_WorkflowController_addComment79_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).addComment)
   }
}
        

// @LINE:123
case controllers_WorkflowController_getComments80_route(params) => {
   call(params.fromPath[Long]("workflowId", None)) { (workflowId) =>
        controllers_WorkflowController_getComments80_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.WorkflowController]).getComments(workflowId))
   }
}
        

// @LINE:125
case controllers_CommentController_addReply81_route(params) => {
   call { 
        controllers_CommentController_addReply81_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).addReply)
   }
}
...
// @LINE:127
case controllers_CommentController_getReply83_route(params) => {
   call(params.fromPath[Long]("commentId", None)) { (commentId) =>
        controllers_CommentController_getReply83_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).getReply(commentId))
   }
}
        

// @LINE:128
case controllers_CommentController_thumbUp84_route(params) => {
   call(params.fromPath[Long]("commentId", None)) { (commentId) =>
        controllers_CommentController_thumbUp84_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).thumbUp(commentId))
   }
}
        

// @LINE:129
case controllers_CommentController_thumbDown85_route(params) => {
   call(params.fromPath[Long]("commentId", None)) { (commentId) =>
        controllers_CommentController_thumbDown85_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).thumbDown(commentId))
   }
}
