...
@Named
@Singleton
public class CommentController extends Template {
    ...
    public Result addReply() {
        Template temp = new CommentController(commentRepository, userRepository, replyRepository);
        return temp.addItem();
    }
